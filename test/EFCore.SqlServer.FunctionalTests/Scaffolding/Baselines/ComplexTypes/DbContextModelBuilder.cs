...
namespace TestNamespace
{
    public partial class DbContextModel
    {
        ...
        private IRelationalModel CreateRelationalModel()
        {
            ...
            var arrayJsonArray = new RelationalJsonArray(manyOwnedColumn, false);
            ...
            var enum1JsonScalar = new RelationalJsonScalar("Enum1", principalJsonObject, false, JsonValueType.String);
            principalJsonObject.AddProperty(enum1JsonScalar);
            var enum2JsonScalar = new RelationalJsonScalar("Enum2", principalJsonObject, true, JsonValueType.String);
            principalJsonObject.AddProperty(enum2JsonScalar);
            var flagsEnum1JsonScalar = new RelationalJsonScalar("FlagsEnum1", principalJsonObject, false, JsonValueType.String);
            principalJsonObject.AddProperty(flagsEnum1JsonScalar);
            var flagsEnum2JsonScalar = new RelationalJsonScalar("FlagsEnum2", principalJsonObject, false, JsonValueType.String);
            ...
            manyOwnedColumn.JsonElement = arrayJsonArray;
